...
export function LoginContent({
  ...
  return (
    ...
    >
      ...
      >
        <div>
          {/* Nimbus mark. Was the OpenHands raised-hands logo — the first
                thing every new user saw on the sign-in screen. */}
          <img src="/favicon.svg" alt="Nimbus" width={72} height={72} />
        </div>
