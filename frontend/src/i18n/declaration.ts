...
export enum I18nKey {
  ...
  SUBAGENT_OBSERVATION$STATUS = "SUBAGENT_OBSERVATION$STATUS",
  SUBAGENT_OBSERVATION$STILL_RUNNING = "SUBAGENT_OBSERVATION$STILL_RUNNING",
  SUBAGENT_OBSERVATION$PARTIAL_RESULT = "SUBAGENT_OBSERVATION$PARTIAL_RESULT",
}
