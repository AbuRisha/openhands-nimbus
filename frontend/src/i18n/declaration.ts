...
export enum I18nKey {
  ...
  CONVERSATION$RESUMING = "CONVERSATION$RESUMING",
  CONVERSATION$RESUME_FAILED = "CONVERSATION$RESUME_FAILED",
  COMMON$ALL = "COMMON$ALL",
  NIMBUS$EFFORT_NOT_SUPPORTED_FOR_MODEL = "NIMBUS$EFFORT_NOT_SUPPORTED_FOR_MODEL",
  SETTINGS$NAV_CONNECTORS = "SETTINGS$NAV_CONNECTORS",
  SETTINGS$NAV_CUSTOMIZE_HEADER = "SETTINGS$NAV_CUSTOMIZE_HEADER",
  SETTINGS$NAV_WORKSPACE_HEADER = "SETTINGS$NAV_WORKSPACE_HEADER",
  SETTINGS$NAV_SEARCH_PLACEHOLDER = "SETTINGS$NAV_SEARCH_PLACEHOLDER",
  SETTINGS$NAV_SEARCH_NO_RESULTS = "SETTINGS$NAV_SEARCH_NO_RESULTS",
  SETTINGS$NAV_CAPABILITIES = "SETTINGS$NAV_CAPABILITIES",
  SETTINGS$NAV_EXTENSIONS = "SETTINGS$NAV_EXTENSIONS",
  SETTINGS$NAV_MEMORY = "SETTINGS$NAV_MEMORY",
  SETTINGS$NAV_DEVELOPER_HEADER = "SETTINGS$NAV_DEVELOPER_HEADER",
  NIMBUS$ACCOUNT$LOADING = "NIMBUS$ACCOUNT$LOADING",
  NIMBUS$ACCOUNT$UNAVAILABLE = "NIMBUS$ACCOUNT$UNAVAILABLE",
  NIMBUS$ACCOUNT$BALANCE = "NIMBUS$ACCOUNT$BALANCE",
  NIMBUS$ACCOUNT$SPENT_IN_CHAT = "NIMBUS$ACCOUNT$SPENT_IN_CHAT",
  NIMBUS$ACCOUNT$CHAT_LIMIT = "NIMBUS$ACCOUNT$CHAT_LIMIT",
  NIMBUS$ACCOUNT$SAVE = "NIMBUS$ACCOUNT$SAVE",
  NIMBUS$ACCOUNT$NO_LIMIT = "NIMBUS$ACCOUNT$NO_LIMIT",
  NIMBUS$ACCOUNT$REMAINING = "NIMBUS$ACCOUNT$REMAINING",
  NIMBUS$ACCOUNT$SAVE_FAILED = "NIMBUS$ACCOUNT$SAVE_FAILED",
  NIMBUS$ACCOUNT$CAP_TOOLTIP = "NIMBUS$ACCOUNT$CAP_TOOLTIP",
  PREVIEW$TITLE = "PREVIEW$TITLE",
  PREVIEW$LOADING = "PREVIEW$LOADING",
  PREVIEW$NO_SERVER = "PREVIEW$NO_SERVER",
  PREVIEW$NOT_SUPPORTED = "PREVIEW$NOT_SUPPORTED",
  PREVIEW$UNAVAILABLE = "PREVIEW$UNAVAILABLE",
  PREVIEW$PORT = "PREVIEW$PORT",
  PREVIEW$RELOAD = "PREVIEW$RELOAD",
  PREVIEW$OPEN_IN_TAB = "PREVIEW$OPEN_IN_TAB",
  REFUSAL$TITLE = "REFUSAL$TITLE",
  REFUSAL$BODY = "REFUSAL$BODY",
  REFUSAL$RETRY_ONCE = "REFUSAL$RETRY_ONCE",
  REFUSAL$RETRY_STICKY = "REFUSAL$RETRY_STICKY",
  REFUSAL$EDIT = "REFUSAL$EDIT",
  REFUSAL$CANCEL = "REFUSAL$CANCEL",
  REFUSAL$NO_FALLBACK = "REFUSAL$NO_FALLBACK",
  QUEUE$WAITING = "QUEUE$WAITING",
  QUEUE$CANCEL = "QUEUE$CANCEL",
  CONVERSATION$SEARCH_PLACEHOLDER = "CONVERSATION$SEARCH_PLACEHOLDER",
  CONVERSATION$SEARCH_NO_RESULTS = "CONVERSATION$SEARCH_NO_RESULTS",
  FIND$IN_CONVERSATION = "FIND$IN_CONVERSATION",
  FIND$PLACEHOLDER = "FIND$PLACEHOLDER",
  FIND$MATCH_COUNT = "FIND$MATCH_COUNT",
  FIND$NEXT = "FIND$NEXT",
  FIND$PREVIOUS = "FIND$PREVIOUS",
  FIND$CLOSE = "FIND$CLOSE",
  PAIRED_BROWSERS$TITLE = "PAIRED_BROWSERS$TITLE",
  PAIRED_BROWSERS$DESCRIPTION = "PAIRED_BROWSERS$DESCRIPTION",
  PAIRED_BROWSERS$CHECKING = "PAIRED_BROWSERS$CHECKING",
  PAIRED_BROWSERS$NONE = "PAIRED_BROWSERS$NONE",
  PAIRED_BROWSERS$CONNECTED = "PAIRED_BROWSERS$CONNECTED",
  PAIRED_BROWSERS$PAIRED_NOT_OPEN = "PAIRED_BROWSERS$PAIRED_NOT_OPEN",
  PAIRED_BROWSERS$LOOKUP_FAILED = "PAIRED_BROWSERS$LOOKUP_FAILED",
  PAIRED_BROWSERS$SIGNED_OUT = "PAIRED_BROWSERS$SIGNED_OUT",
  PAIRED_BROWSERS$SIGN_IN_AGAIN = "PAIRED_BROWSERS$SIGN_IN_AGAIN",
  PAIRED_BROWSERS$CODE_INSTRUCTION = "PAIRED_BROWSERS$CODE_INSTRUCTION",
  PAIRED_BROWSERS$PAIR_A_BROWSER = "PAIRED_BROWSERS$PAIR_A_BROWSER",
  PAIRED_BROWSERS$GENERATE_NEW_CODE = "PAIRED_BROWSERS$GENERATE_NEW_CODE",
  PAIRED_BROWSERS$GENERATING = "PAIRED_BROWSERS$GENERATING",
  PAIRED_BROWSERS$CODE_FAILED = "PAIRED_BROWSERS$CODE_FAILED",
  CONDENSATION$HISTORY_CONDENSED = "CONDENSATION$HISTORY_CONDENSED",
  CONDENSATION$HISTORY_CONDENSED_COUNT = "CONDENSATION$HISTORY_CONDENSED_COUNT",
  CONDENSATION$SHOW_SUMMARY = "CONDENSATION$SHOW_SUMMARY",
  CONDENSATION$HIDE_SUMMARY = "CONDENSATION$HIDE_SUMMARY",
  HELP$TITLE = "HELP$TITLE",
  HELP$FOOTER = "HELP$FOOTER",
  COMMAND_PALETTE$TITLE = "COMMAND_PALETTE$TITLE",
  COMMAND_PALETTE$PLACEHOLDER = "COMMAND_PALETTE$PLACEHOLDER",
  COMMAND_PALETTE$NO_RESULTS = "COMMAND_PALETTE$NO_RESULTS",
  COMMAND_PALETTE$GROUP_SETTINGS = "COMMAND_PALETTE$GROUP_SETTINGS",
  FORK$RETRY_FROM_HERE = "FORK$RETRY_FROM_HERE",
  FORK$FILES_UNCHANGED_WARNING = "FORK$FILES_UNCHANGED_WARNING",
  FORK$ERROR_NOT_FOUND = "FORK$ERROR_NOT_FOUND",
  FORK$ERROR_SANDBOX_NOT_RUNNING = "FORK$ERROR_SANDBOX_NOT_RUNNING",
  FORK$ERROR_PARTIAL = "FORK$ERROR_PARTIAL",
  FORK$ERROR_GENERIC = "FORK$ERROR_GENERIC",
  FORK$HALVES_DISAGREE = "FORK$HALVES_DISAGREE",
  DIFF_VIEWER$LOAD_FAILED = "DIFF_VIEWER$LOAD_FAILED",
  PERMISSION_MODE$LABEL = "PERMISSION_MODE$LABEL",
  PERMISSION_MODE$NEVER = "PERMISSION_MODE$NEVER",
  PERMISSION_MODE$NEVER_DESC = "PERMISSION_MODE$NEVER_DESC",
  PERMISSION_MODE$RISKY = "PERMISSION_MODE$RISKY",
  PERMISSION_MODE$RISKY_DESC = "PERMISSION_MODE$RISKY_DESC",
  PERMISSION_MODE$ALWAYS = "PERMISSION_MODE$ALWAYS",
  PERMISSION_MODE$ALWAYS_DESC = "PERMISSION_MODE$ALWAYS_DESC",
  PERMISSION_MODE$UPDATE_FAILED = "PERMISSION_MODE$UPDATE_FAILED",
  SETTINGS$NAV_CONVERSATION_LENGTH = "SETTINGS$NAV_CONVERSATION_LENGTH",
  MEMORY$TITLE = "MEMORY$TITLE",
  MEMORY$DESCRIPTION = "MEMORY$DESCRIPTION",
  MEMORY$PLACEHOLDER = "MEMORY$PLACEHOLDER",
  MEMORY$SAVE = "MEMORY$SAVE",
  MEMORY$CHAR_COUNT = "MEMORY$CHAR_COUNT",
  MEMORY$OVER_LIMIT = "MEMORY$OVER_LIMIT",
  MEMORY$SAVE_FAILED = "MEMORY$SAVE_FAILED",
  STATUS$SESSION_EXPIRED_RELOAD = "STATUS$SESSION_EXPIRED_RELOAD",
  BUTTON$RELOAD_PAGE = "BUTTON$RELOAD_PAGE",
  FORK$RETRYING = "FORK$RETRYING",
  ARTIFACTS$TITLE = "ARTIFACTS$TITLE",
  ARTIFACTS$DESCRIPTION = "ARTIFACTS$DESCRIPTION",
  ARTIFACTS$EMPTY = "ARTIFACTS$EMPTY",
  ARTIFACTS$SELECT_ONE = "ARTIFACTS$SELECT_ONE",
  ARTIFACTS$HISTORY = "ARTIFACTS$HISTORY",
  ARTIFACTS$CURRENT = "ARTIFACTS$CURRENT",
  ARTIFACTS$VERSION_N = "ARTIFACTS$VERSION_N",
  ARTIFACTS$VERSION_COUNT = "ARTIFACTS$VERSION_COUNT",
  ARTIFACTS$RESTORED_FROM = "ARTIFACTS$RESTORED_FROM",
  ARTIFACTS$RESTORE_VERSION = "ARTIFACTS$RESTORE_VERSION",
  ARTIFACTS$SAVE_VERSION = "ARTIFACTS$SAVE_VERSION",
  ARTIFACTS$DELETE = "ARTIFACTS$DELETE",
  ARTIFACTS$DELETE_WARNING = "ARTIFACTS$DELETE_WARNING",
  ARTIFACTS$SAVE_FAILED = "ARTIFACTS$SAVE_FAILED",
  ARTIFACTS$RESTORE_FAILED = "ARTIFACTS$RESTORE_FAILED",
  ARTIFACTS$DELETE_FAILED = "ARTIFACTS$DELETE_FAILED",
  ARTIFACTS$KEEP_THIS = "ARTIFACTS$KEEP_THIS",
  ARTIFACTS$KEPT = "ARTIFACTS$KEPT",
  ARTIFACTS$UNTITLED = "ARTIFACTS$UNTITLED",
  STATUS$CONNECTION_REFUSED_RELOAD = "STATUS$CONNECTION_REFUSED_RELOAD",
  ARTIFACTS$PRINT = "ARTIFACTS$PRINT",
}
