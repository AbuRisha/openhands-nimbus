...
export enum I18nKey {
  ...
  WORKSPACE$FILES_LOADING = "WORKSPACE$FILES_LOADING",
  WORKSPACE$FILES_NO_MATCH = "WORKSPACE$FILES_NO_MATCH",
  WORKSPACE$FILES_UNAVAILABLE = "WORKSPACE$FILES_UNAVAILABLE",
  WORKSPACE$FILES_TRUNCATED = "WORKSPACE$FILES_TRUNCATED",
}
